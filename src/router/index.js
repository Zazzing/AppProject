...
import sofas from '@/components/sofas'             //导入沙发选项卡 
import curtains from '@/components/curtains'       //导入窗帘选项卡
import cupboards from '@/components/cupboards'     //导入橱柜选项卡  
import wardrobes from '@/components/wardrobes'     //导入衣柜选项卡   
import bathrooms from '@/components/bathrooms'     //导入卫浴选项卡 
import all from '@/components/all'                 //导入所有选项卡   
...
export const router = new Router({
  routes: [
    ...
    { path: '/cupboards' ,name:'cupboards' ,component:cupboards},
